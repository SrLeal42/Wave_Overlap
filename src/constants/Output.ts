...
export const DEFAULT_FX_PARAMS: Record<number, EffectParams> = {
    ...
    [ColorEffect.Rotate]: { speed: 1.5, param1: 0.0, param2: 0.0, param3: 0.0 },
    // Rotate: velocidade de rotação do hue em OKLab
    ...
    [ColorEffect.Glitch]: { speed: 1.0, param1: 0.92, param2: 0.0, param3: 0.0 },
